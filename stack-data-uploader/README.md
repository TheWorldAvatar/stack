...
| [rml-advanced](../examples/datasets/inputs/config/rml_advanced.json)             | An example of uploading more advanced YARRRML rules (involving conditions and functions) and a CSV file into a custom Blazegraph namespace.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
